...
export function SiteFooter() {
  return <footer className="site-footer">
    <div className="container footer-main">
      ...
      <div className="footer-column"><span className="footer-label">Fale conosco</span><a href={whatsappUrl("Olá! Vim pelo site da Auto Peças Martins.")} target="_blank" rel="noreferrer"><WhatsAppIcon size={20} /><span><small>WhatsApp</small>{store.phoneDisplay}</span></a><a href="https://www.instagram.com/autopecas_martinss/" target="_blank" rel="noreferrer" aria-label="Instagram da Auto Peças Martins"><InstagramIcon size={20} /><span><small>Instagram</small>@autopecas_martinss</span></a><a href={mapsUrl} target="_blank" rel="noreferrer"><Pin size={18} /><span><small>Visite a loja</small>{store.address}<br />{store.city} · {store.state}</span></a></div>
      <div className="footer-column footer-hours-column"><span className="footer-label">Horário</span><div className="footer-hours"><Clock size={18} /><span>{store.hours.map((hour) => <small key={hour}>{hour}</small>)}<small>Feriados: consulte a equipe</small></span></div><a className="bythe-credit" href="https://bythe.tech" target="_blank" rel="noreferrer" aria-label="Site desenvolvido pela BYTHE Technology"><span>DESENVOLVIDO POR</span><Image src="/brand/bythe-mark-blue.svg" alt="BYTHE" width={38} height={30} /></a></div>
    </div>
